...
public enum EDatabase4DriverClassName {
    ...
    REDSHIFT(
            EDatabaseTypeName.REDSHIFT,
            new String[] { "com.amazon.redshift.jdbc41.Driver", "com.amazon.redshift.jdbc.Driver" }, //$NON-NLS-1$
            new String[0]),
    ...
    SYBASEASE(
            ...
            new String[] {
                    "com.sybase.jdbc3.jdbc.SybDriver", "com.sybase.jdbc3.jdbc.SybDataSource" }, //$NON-NLS-1$
            new String[] {}),
    SYBASEIQ(
            EDatabaseTypeName.SYBASEIQ,
            new String[] { "com.sybase.jdbc3.jdbc.SybDriver", "com.sybase.jdbc3.jdbc.SybDataSource" }, //$NON-NLS-1$
            new String[] {}),
    SYBASEIQ_16(
            EDatabaseTypeName.SYBASEASE,
            new String[] { "com.sybase.jdbc4.jdbc.SybDriver", "com.sybase.jdbc4.jdbc.SybDataSource" }, //$NON-NLS-1$
            new String[] {}),
