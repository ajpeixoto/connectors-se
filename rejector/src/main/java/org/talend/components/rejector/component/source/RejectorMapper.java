...
@PartitionMapper(name = "RejectorSource")
@Icon(value = IconType.CUSTOM, custom = "rejector")
@Version(1)
@Documentation("Mapper for Rejector.")
public class RejectorMapper implements Serializable {
    ...
    public RejectorMapper(@Option("configuration") final RejectorInputConfiguration configuration,
    ...
    @Split
    public List<RejectorMapper> split(@PartitionSize final long desiredSize) {
