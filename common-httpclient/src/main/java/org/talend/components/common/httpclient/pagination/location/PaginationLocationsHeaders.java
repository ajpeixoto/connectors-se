...
public class PaginationLocationsHeaders implements PaginationLocation {

    private final PaginationLocationService paginationLocationService;

    public PaginationLocationsHeaders() {
    ...
    public void setPagination(QueryConfiguration queryConfiguration) {
        List<KeyValuePair> keyValuePairs = queryConfiguration.getHeaders();
        ...
        queryConfiguration.setHeaders(updatedKeyValuePairs);
    }
